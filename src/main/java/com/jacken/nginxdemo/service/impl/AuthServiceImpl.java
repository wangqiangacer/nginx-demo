...
import com.jacken.nginxdemo.utils.Base64Util;
import com.jacken.nginxdemo.utils.FileUtil;
import com.jacken.nginxdemo.utils.GsonUtils;
import com.jacken.nginxdemo.utils.HttpUtil;
...
//        String token = getAuth(clientId, clientSecret);
    ...
    public static String faceDetect()  throws Exception{
        ...
        byte[] data = getPageLocalData("C:\\Users\\wangqiang\\Desktop\\girl_20200314124616.jpg");
